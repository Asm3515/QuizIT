...
export function TopMelancholicSongs() {
    const [queryResults, setQueryResults] = useState([]);

    async function fetchQueryResults() {
        try {
            const response = await fetch('http://localhost:3001/best-melancholic-songs');
    ...
    return (
        <>
            <Header />
            <h1 className="text-3xl text-center font-bold m-4">Top 50 Melancholic Songs</h1>
